...
http://tiplus.tistory.com/698
			...
			Insomnia (Cross-Platform) - postman 과 비슷한 api통신 테스트기?
			협업 툴(메신저, R&R, 그룹웨어
				메신저
					슬랙
						장: 가장 대중적
					팀즈
						장: 팀, 개인 가능, 고용량 파일전송은 안해봤지만 저용량 파일전송 빠름. 멘션 가능, 전용 앱 보유.
						단: 모바일앱에선 속도가 좀 느린편. 
					잔디 - http://blog.jandi.com/ko/2019/01/07/project_management_with_jandi/
					라인
					네이트온
					그랩 - https://www.grap.io/ko/intro
				디자인관련
					픽셀릭 - https://medium.com/pixelic-korea/pixelic-for-figma-97d568032580
					피그마
				프로젝트 관련 
					트렐로
				그룹웨어
					...
					하이웍스
						장: 관리는 딱히 안해도됨
						단: 그룹웨어랑 연동해서 익스트라넷 쓸때 발송하는데 그때 느림. 용량제한 200메가
		window 
...
screenpen - 바탕화면에 그림그리기2
	...
	기타
		...
		팁
			...
			글자 비교 프로그램 [ winmerge ]- http://zzarungna.tistory.com/658
			MSI 
...
https://hunter.io/email-verifier
			...
			커피카페인 함량 - https://m.blog.naver.com/PostView.nhn?blogId=leesir8811&logNo=20168693673&proxyReferer=https%3A%2F%2Fwww.google.com%2F
		읽을거리
